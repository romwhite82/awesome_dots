...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({modkey,  }, "F1", function() awful.util.spawn("firedragon") end, 
              {description = "Open browser", group = "programs"}),

    awful.key({modkey, "Shift"  }, "s", function() awful.util.spawn("scrot '%Y-%m-%d.png' -s -b -e 'mv $f ~/Изображения/Screenshot'") end, 
